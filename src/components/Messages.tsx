...
const Messages: FC<MessagesProps> = ({ initialMessages, sessionId,chatId, sessionImg, chatPartner }) => {
  ...
  return (
    <div
      id="messages"
      className="flex h-full flex-1 flex-col-reverse gap-4 p-3 overflow-y-auto scrollbar-thumb-blue scrollbar-thumb-rouned scrollbar-track-blue-lighter scrollbar-w-2 scrolling-touch"
    >
      ...
      {messages.map((message, index) => {
        ...
        return (
          ...
          >
            ...
            >
              <div className={cn('flex flex-col space-y-2 text-base max-w-xs mx-2',{'order-1 items-end' : isCurrentUser,
